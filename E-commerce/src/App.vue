...
import kiwiImage from '@/assets/kiwis.png'
...
import strawberryShakeImage from '@/assets/strawberryShake.png'
import freshVeggieImage from '@/assets/freshVeggie.jpg'
